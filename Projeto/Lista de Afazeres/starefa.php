<?php
   ...
   include "conexao.inc";
     ...
     $vtexto=$_POST["texto-form"];
     $vdata=$_POST["data"];

     $sql="INSERT INTO tarefas VALUES ('$vtexto', '$vdata', NULL)";
    ...
    <div class="row">
     ...
     <div class="col-md-6" style="border-right: 1px solid #000000;">
      ...
      <div class="form-group text-center"> 
        ...
        <input class="form-control" type="text" placeholder="Insira uma tarefa.." name="texto-form" required>
       ...
       <div id="success" style="margin-top: 10px;">
            <?php
